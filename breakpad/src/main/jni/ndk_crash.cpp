...
Java_com_decay_breakpad_CrashReport_initBreakpad(JNIEnv *env, jclass type, jstring path_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_decay_breakpad_CrashReport_testNativeCrash(JNIEnv *env, jclass clazz) {
